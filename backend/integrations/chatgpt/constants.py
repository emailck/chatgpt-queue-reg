...
OPENAI_API_ENDPOINTS = {
    ...
    "client_auth_session_dump": "https://auth.openai.com/api/accounts/client_auth_session_dump",
...
# ext-passkey-client-capabilities 的模拟值。
# 来源: 浏览器调用 PublicKeyCredential.getClientCapabilities() 后
# 将 4 个布尔值逐位编码为 "0"/"1":
#   conditionalCreate | conditionalGet | relatedOrigins | prf
# QuickJS/HTTP 模式下无法调用 WebAuthn API，按模拟 Chrome 130+ 设定。
PASSKEY_CLIENT_CAPABILITIES = "1111"
