...
PRESETS: dict[str, tuple[str, ...]] = {
    ...
    "tinkmail_email_register":             ("tinkmail_email_register",),
    "register_only":                       ("register",),
    "register_with_sub2api":               ("register", "chatgpt_session", "sub2api_sync"),
    "chatgpt_mfa_setup_only":              ("chatgpt_mfa_setup",),
    "chatgpt_password_setup_only":         ("chatgpt_password_setup",),
    "register_with_mfa_setup":             ("register", "chatgpt_session", "chatgpt_mfa_setup"),
    "register_with_mfa_setup_sub2api":     ("register", "chatgpt_session", "chatgpt_mfa_setup", "sub2api_sync"),
    "register_with_password_setup":        ("register", "chatgpt_password_setup"),
    "register_with_password_setup_sub2api": ("register", "chatgpt_password_setup", "chatgpt_session", "sub2api_sync"),
    "register_with_password_setup_mfa":    ("register", "chatgpt_password_setup", "chatgpt_mfa_setup"),
    "register_with_password_setup_mfa_sub2api": ("register", "chatgpt_password_setup", "chatgpt_mfa_setup", "chatgpt_session", "sub2api_sync"),
    ...
    "pp_long_link_only":                    ("pp_long_link",),
    "register_pp_long_link":                ("register", "pp_long_link"),
    ...
    "codex_invitation_only":               ("codex_invitation",),
    "codex_invite_sso_active":             ("codex_invitation", "sso_oauth", "active"),
    "codex_batch_invite_active":           ("codex_batch_invite",),
    "sso_workspace_join":                  ("sso_oauth", "workspace_join"),
    "workspace_join_only":                 ("workspace_join",),
    # Browser userscript equivalent:
    #   /api/auth/session accessToken -> POST /backend-api/accounts/{ws}/invites/request
    # It only sends "request" and does not switch workspace/session afterwards.
    "workspace_request_only":              ("workspace_join",),
    "register_workspace_request":          ("register", "workspace_join"),
    "team_codex_token_sub2api":            ("codex_token", "sub2api_sync"),
    "register_team_codex_token_sub2api":   ("register", "codex_token", "sub2api_sync"),
    "active_only":                         ("active",),
}
...
CARRY_OVER_KEYS: tuple[str, ...] = (
    ...
    "upload_multiple",
    "workspace_joined",
    "switched_workspace_id",
    "workspace_session_switched",
    "workspace_session_plan_type",
    "workspace_session_access_token",
    "workspace_sessions",
    "codex_token_created",
