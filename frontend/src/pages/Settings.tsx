    ...
    >
      ...
      <div className="entity-grid">
        ...
        <EntityCard
          ...
          subtitle="register / payment_link / payment / chatgpt_session / chatgpt_password_setup / openai_oauth / sub2api_sync"
          tone="info"
        ...
        >
          <KeyValueGrid>
            ...
            <KeyValue label="chatgpt_password_setup" value="ChatGPT 设置密码配置" />
